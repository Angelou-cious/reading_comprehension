...
class _EditQuizScreenState extends State<EditQuizScreen> {
  ...
  Widget _buildQuestionCard(int index) {
    final Map<String, String> answers = (_questions[index]['answers'] as Map)
        .map<String, String>(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                ElevatedButton.icon(
                  onPressed: _isEditable && answers.length > 3
                      ? () => _removeAnswer(index, answerKeys.last)
                      : null, // ✅ Disable if not editable
        ...
        children: [
          ...
          Radio<String>(
            ...
            onChanged: _isEditable
                ? (value) => _updateCorrectAnswer(questionIndex, value)
                : null, // ✅ Disable if not editable
          ),
          const Text('Correct'),
          IconButton(
            ...
            onPressed: _isEditable
                ? () => _clearAnswer(questionIndex, answerKey)
                : null, // ✅ Disable if not editable
          ),
        ],
      ),
  ...
  void _addAnswer(int questionIndex) {
    setState(() {
      final answers =
          _questions[questionIndex]['answers'] as Map<String, String>;
    ...
    setState(() {
      ...
      if (answers.length > 3) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('A question must have at least 3 answers'),
          ),
        );
      }
    });
