...
import 'package:phil/admin/admin_login_page.dart';
import 'package:phil/sign_up_page.dart';
import 'package:phil/student/student_login.dart';
...
class _SignInState extends State<SignIn> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: _loading
          ? Background(child: const Center(child: CircularProgressIndicator()))
          : Stack(
              children: [
                Background(
