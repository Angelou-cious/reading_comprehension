...
import 'package:phil/student/profile_page.dart';
    ...
    try {
      ...
      if (studentDoc.exists && mounted) {
        setState(() {
          ...
          profilePictureUrl =
              studentDoc.data().toString().contains('profilePictureUrl')
    ...
    showDialog(
      ...
      builder: (context) {
        return const AlertDialog(
          title: Text("Help"),
          content: Text(
            "This is a reading comprehension app for students to take assessments and track progress.",
          ),
        );
      },
    );
