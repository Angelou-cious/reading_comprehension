...
import 'package:phil/Screens/privacy_policy_page.dart';
import 'package:phil/main.dart';
import 'package:phil/teacher/teacher_instruction.dart';
import 'package:phil/teacher/teacher_profile.dart';
import 'package:firebase_storage/firebase_storage.dart';
import 'package:image_picker/image_picker.dart';
import 'package:permission_handler/permission_handler.dart';
import 'package:phil/utils/logger.dart';
    ...
    try {
      ...
      if (teacherDoc.exists && mounted) {
        ...
        setState(() {
          ...
          profilePictureUrl = data.containsKey('profilePictureUrl')
                ...
                ListTile(
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const TeacherInstructionPage(),
                      ),
                    );
                  },
                ),
