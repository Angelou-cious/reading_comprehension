...
import 'package:phil/utils/code_generator.dart';
import 'package:phil/teacher/teacher_login.dart';
  ...
  void _validateInputs() {
    setState(() {
      ...
      _confirmPasswordError =
          ...
          : null;
      _schoolError = _selectedSchoolId == null
  ...
  Future<void> signUp() async {
    ...
    try {
      ...
      await FirebaseFirestore.instance.collection('Logs').add({
        'message':
            'Teacher "${_firstNameController.text.trim()} ${_lastNameController.text.trim()}" created an account',
